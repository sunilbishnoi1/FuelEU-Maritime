...
interface CustomSelectProps extends React.ComponentPropsWithoutRef<typeof SelectPrimitive.Root> {
  ...
  options: Option[];
  placeholder?: string;
  className?: string; // Add className to CustomSelectProps
}

const CustomSelect = React.forwardRef<
  React.ElementRef<typeof SelectPrimitive.Trigger>,
  CustomSelectProps
>(({ id, value, onValueChange, options, placeholder, className, ...props }, ref) => (
  <Select value={value} onValueChange={onValueChange} {...props}>
    <SelectTrigger id={id} ref={ref} className={className}> {/* Pass className to SelectTrigger */}
...
export {
  ...
  SelectItem,
  SelectSeparator,
  CustomSelect, // Export the new combined Select
}
